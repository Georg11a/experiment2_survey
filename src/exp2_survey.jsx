    ...
    <div style={{
      ...
      <div style={{ display: "flex", gap: 16, alignItems: "flex-start", flexWrap: "wrap" }}>
        ...
        <div style={{
          ...
          <div style={{ fontSize: 13, color: "#2a8fc1", fontWeight: 600, padding: "6px 0", background: "#e8f4fb" }}>Click the image to enlarge</div>
        </div>
...
function ImageModal({ src, onClose }) {
  ...
  return (
    <div onClick={onClose} style={{
      ...
      cursor: "pointer", padding: 20, overflowY: "auto",
    }}>
      <div onClick={(e) => e.stopPropagation()} style={{
        background: "#fff", borderRadius: 12, padding: 16,
        maxWidth: "95vw", margin: "20px 0",
...
export default function Exp2Survey() {
  ...
  if (trialStep >= 0 && trialStep < 12) {
    ...
    if (pageIdx === 0) {
      ...
      return (
        <TrialLayout trialIdx={trialIdx} pageLabel="Page 1 of 3" imagePath={imagePath}
    ...
    if (pageIdx === 1) {
      ...
      return (
        <TrialLayout trialIdx={trialIdx} pageLabel="Page 2 of 3" imagePath={imagePath}
          modalImage={modalImage} setModalImage={setModalImage}>
          <div style={{
            background: "#fff", borderRadius: 12, padding: "28px 32px",
            boxShadow: "0 1px 4px rgba(0,0,0,.06)", border: "1px solid #e8ecf1",
